...
export const PAGE_FILES = Object.freeze([
  ...
  "styles.css",
  "site.webmanifest",
  "assets/favicon-monogram-32.png",
  "assets/apple-touch-icon-monogram.png",
  "assets/icon-monogram-192.png",
  "assets/icon-monogram-512.png",
  "assets/estate.jpg",
  "assets/tennis.png",
...
export const pagePolicy = (config = SITE_CONFIG) =>
  [
    ...
    "script-src 'self'",
    "style-src 'self'",
    `img-src 'self' data: ${normalizeSiteConfig(config).apiOrigin}`,
    "font-src 'none'",
