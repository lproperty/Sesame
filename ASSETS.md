...
| `public/assets/favicon.svg`                                                         | Original geometric Sesame S mark in a blue-and-white gradient palette |
| `public/assets/apple-touch-icon-blue.png`, `icon-blue-192.png`, `icon-blue-512.png` | Raster versions of the original Sesame S mark                         |

The iPhone Home Screen icon is an opaque 180 × 180 PNG; iOS applies its own corner mask. The manifest includes 192 × 192 and 512 × 512 versions. The blue icon filenames let browsers fetch the new artwork independently of older cached icons. The SVG retains the editable vector design. No third-party logo artwork is included in the app.
